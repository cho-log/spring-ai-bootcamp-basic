...
public class ChatbotService {
    ...
    public ChatbotResponse chat(ChatbotRequest request) {
        ...
        // 검색
        SearchRequest searchRequest = getSearchRequest(query, 4);
        ...
        ChatResponse chatResponse = chatClient.prompt()
            .system("""
                ...
                아래의 규칙을 엄격하게 준수하십시오.
                - 반드시 모든 답변은 컨텍스트에 있는 정보를 기반으로 생성하세요. 절대 컨텍스트에 없는 정보를 추론하거나 사실인 것처럼 대답하지 마세요.
    ...
    private Query getQuery(ChatbotRequest request) {
